  ...
  $("#product-form").submit(function (e) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $(
          '[name="name"], [name="price"], [name="image"], [name="category"]'
        ).val("");
        loadProducts();
      },
      error: function (xhr) {
                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="${p.image}" alt="${
            p.name
          }" class="pro-image-front img-responsive">
                                    <img src="${p.image}" alt="${
            p.name
          }" class="pro-image-back img-responsive">
                                ...
                                <div class="item-info-product">
                                    ...
                                    <div class="info-product-price">
                                        <span class="item_price">$${p.price.toFixed(
                                          2
                                        )}</span>
                                        <del>$${(p.price * 1.5).toFixed(
                                          2
                                        )}</del>
                                    </div>
